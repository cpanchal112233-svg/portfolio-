...
export const beats: Beat[] = [
  ...
  },
  {
    ...
    kind: 'statement',
    label: 'Currently',
    text: 'Currently shipping TARU, an AI-powered health companion built on Flutter and Firebase.',
    narration: 'Right now my focus is TARU — an AI health companion. I point it out properly in a moment.',
    emphasis: 'point',
  },
  {
    id: 'about-value',
  ...
  // —— 02 Work ——
  {
    ...
    detail:
      'iOS and Android app helping people understand their health, organise medical information, build habits, and partner better with clinicians. Auth, Firestore profiles, and the app shell are shipped; report uploads, an LLM assistant, routines, and insights are next.',
    chips: ['Flutter', 'Dart', 'Firebase Auth', 'Cloud Firestore', 'Firebase Storage'],
    href: 'https://github.com/cpanchal112233-svg/TARU-',
    external: true,
    status: 'In progress',
    narration: 'Here it is — TARU. This is the build I am proudest of, and it is live on GitHub.',
    emphasis: 'point',
  },
  {
    id: 'work-taru-why',
  ...
  },
  {
    ...
    kind: 'skillgroup',
    label: 'Mobile & AI',
    text: 'Where I am building next',
    chips: ['Flutter', 'Dart', 'Firebase', 'Cloud Firestore', 'LLM product design'],
    narration: 'This is the row that matters most right now: Flutter, Firebase, and LLM product design.',
    emphasis: 'point',
  },
  {
    id: 'skill-backend',
  ...
  },
  {
    ...
    kind: 'resume',
    label: 'Profile',
    text: 'Full-stack and mobile engineer with ERP delivery experience and a current focus on AI-powered health software.',
    narration: 'This is the summary a recruiter reads first, so I keep it honest and specific.',
    emphasis: 'reflect',
  },
  {
    id: 'resume-core',
